                ...
                <div class="col-lg-10">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="section-title">
                            ...
                            <h1 class="text-anime-style-2" data-cursor="-opaque">Designing your dream spaces, one room
                                at a time</h1>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-2" data-cursor="-opaque">Our passion for design, your
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Our dedicated team of designers works
                                ...
                                attention to detail. Whether it's transforming a single room or an entire home.</p>
                        </div>
                        <!-- Section Title End -->
            ...
            <div class="row section-row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-2" data-cursor="-opaque">Innovative design services for
            ...
            <div class="row section-row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="section-title-content dark-section">
                        <p class="wow fadeInUp" data-wow-delay="0.2s">Our comprehensive approach guides you through
                            each phase of the design process, from initial brainstorming and conceptualization.</p>
                    </div>
                    <!-- Section Title Content End -->
                </div>
            </div>
